...
const BackupCodesModal: React.FC<BackupCodesModalProps> = ({ visible, codes, onClose }) => (
...
const TwoFactorSetup: React.FC<TwoFactorSetupProps> = ({ visible, onClose, onSetupComplete }) => {
                ...
                <View style={styles.setupStep}>
                  ...
                  {manualKey && (
                    <View style={styles.manualEntry}>
                      <Text style={styles.manualTitle}>Can't scan? Enter this key manually:</Text>
